...
const RelatedProducts = ({ products = [], currentProductId = null }) => {
  ...
  const filteredProducts = products?.filter(product => product?.id !== currentProductId)?.slice(0, 4);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {filteredProducts?.map((product) => (
          <div key={product?.id} className="group bg-surface border border-border rounded-lg overflow-hidden hover:shadow-elevation-2 transition-all duration-200">
            ...
            <div className="p-3 space-y-2">
              ...
              <div className="pt-2 space-y-2">
                <Link to="/product-detail" state={{ productId: product?.id }}>
